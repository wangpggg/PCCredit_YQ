...
$(".addbtn").click(function(){
	...
	var str =' <tr id="'+ childtrid + '"><td style="width: 150px;"><input type="text" class="rinpstyname" name="items_name_'+ trid +'" value="" style="text-align: center;" onchange="isempty(this)"/></td><td style="width: 150px;"><input class="rinpstyname" type="text" id="" name="month_1_'+ trid +'" value="" onchange="count1(this,' + trid +',1)" /></td><td style="width: 150px;"><input class="rinpsty" type="text" id="" name="month_2_'+ trid +'" value="" onchange="count1(this,' + trid +',2)" /></td><td style="width: 150px;"><input class="rinpstyname" type="text" id="" name="month_3_'+ trid +'" value="" onchange="count1(this,' + trid +',3)" /></td><td style="width: 150px;"><input class="rinpstyname" type="text" id="" name="month_4_'+ trid +'" value="" onchange="count1(this,' + trid +',4)"  /></td><td style="width: 150px;"><input class="rinpsty" type="text" id="" name="month_5_'+ trid +'" value="" onchange="count1(this,' + trid +',5)"  /></td><td style="width: 150px;"><input class="rinpsty" type="text" id="" name="month_6_'+ trid +'" value="" onchange="count1(this,' + trid +',6)"  /></td></tr>';
