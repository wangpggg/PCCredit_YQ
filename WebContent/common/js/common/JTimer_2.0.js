...
var JTC = (function () {
    ...
    config = {
        dayBgColor: ['#bdebee', '#FFFFFF', '#bdebee'], //鼠标移动的颜色
        dayColor: ['#ff2f2f', '#000000', '#888888'], //日期字体颜色:1.上月和下月的日期; 2.本月; 3.不可选时
    ...
    dialog = function () {
        ...
        this.getWeekDayPanel = function () {
            ...
            var style = 'height:23px; border-top:0px; border-bottom:1px solid #ccc; border-right:0px; border-left:0px;background-color:#FFFFFF;';
            for (var i = 0; i < 7; i++) {
        ...
        var style = 'border:1px solid #ccc; font-size:12px; text-align:center;';
