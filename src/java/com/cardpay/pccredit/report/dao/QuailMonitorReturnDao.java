 ...
 */
@Mapper
public interface QuailMonitorReturnDao {
	//“灵活金”业务/普通信用卡进件质量监测报表统计期间：（XXXX年XX月XX日-XXXX年XX月XX日） 客户经理/微贷经理维度, ReturnApprove
	public List<QuailManaReturnMonitor> getQuailReturnMonitorStatistical(StatisticalFilter filter);
	//“灵活金”/普通信用卡业务进件质量监测报表统计期间：（XXXX年XX月XX日-XXXX年XX月XX日）一级支行/二级支行维度,ReturnApprove
