 ...
 */
@Controller
@RequestMapping("/notificationmessage/notificationmessage/*")
@JRadModule("notificationmessage.notificationmessage")
public class QitaNotificationMessageController extends BaseController {
	...
	public AbstractModelAndView browse(@ModelAttribute NotificationMessageFilter filter, HttpServletRequest request) {
		...
		filter.setNoticeType(NotificationEnum.qita.toString());
