 ...
 */
@Controller
@RequestMapping("/notificationmessage/customerinfochangemessage/*")
@JRadModule("notificationmessage.customerinfochangemessage")
public class CustomerInfoNotificationMessageController extends BaseController {
	...
	public AbstractModelAndView browse(@ModelAttribute NotificationMessageFilter filter, HttpServletRequest request) {
		...
		filter.setNoticeType(NotificationEnum.yuanshiziliao.toString());
