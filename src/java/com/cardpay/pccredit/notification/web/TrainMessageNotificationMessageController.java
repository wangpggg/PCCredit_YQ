 ...
 */
@Controller
@RequestMapping("/notificationmessage/trainmessage/*")
@JRadModule("notificationmessage.trainmessage")
public class TrainMessageNotificationMessageController extends BaseController {
