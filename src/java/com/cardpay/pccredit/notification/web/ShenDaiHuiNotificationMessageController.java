 ...
 */
@Controller
@RequestMapping("/notificationmessage/shendaihuimessage/*")
@JRadModule("notificationmessage.shendaihuimessage")
public class ShenDaiHuiNotificationMessageController extends BaseController {
	...
	public AbstractModelAndView sdh_browse(@ModelAttribute NotificationMessageFilter filter, HttpServletRequest request) {
		...
		filter.setNoticeType(NotificationEnum.shendaihui.toString());
