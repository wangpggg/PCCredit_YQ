 ...
 * 调查模板-利润简表
 */
@ModelParam(table = "TY_DZ_MODEL_LRJB")
public class Dclrjb extends BusinessModel{
	...
	private String  srjh;           
	private String  srxs;           
	private String  kbcbxs;         
	private String  qtsrfx;         
	private String  kz;             
	private String  lrjs;
	public String getId() {
		return id;
	...
	public void setA160(String a160) {
		this.a160 = a160;
	}
	...
	public String getA164() {
		return a164;
	}
	public void setA164(String a164) {
		this.a164 = a164;
	}
	...
	public String getSrjh() {
		return srjh;
	}
	public void setSrjh(String srjh) {
		this.srjh = srjh;
	}
	public String getSrxs() {
		return srxs;
	}
	public void setSrxs(String srxs) {
		this.srxs = srxs;
	}
	public String getKbcbxs() {
		return kbcbxs;
	}
	public void setKbcbxs(String kbcbxs) {
		this.kbcbxs = kbcbxs;
	}
	public String getQtsrfx() {
		return qtsrfx;
	}
	public void setQtsrfx(String qtsrfx) {
		this.qtsrfx = qtsrfx;
	}
	public String getKz() {
		return kz;
