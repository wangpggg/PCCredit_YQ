 ...
 * 2014-11-11上午9:36:48
 */
@ModelParam(table = "maintenance_schedule")
public class MaintenanceSchedule extends BusinessModel {
	private static final long serialVersionUID = 3724629277945324986L;
	// 客户ID
